			...
			var LinkTo = function (_HTMLElement2) {
				...
				_createClass(LinkTo, [{
					...
					value: function connectedCallback() {
						...
						this.handleLtProp();
						var isCustom = ha("lt-prop-custom") || this.ltProp.custom,
						    linkTag = void 0;
						if (isCustom) {
							...
							for (var _i2 = 0, childNode; childNode = this.childNodes[_i2]; _i2++) {
					...
					value: function setCustomAttributes(linkTag, onlyLtProp) {
						...
						if (!onlyLtProp) {
							for (var _i3 = 0, attr; attr = attr = this.attributes[_i3]; _i3++) {
 ...
 */
	...
	var customElementPrototype = function (_elementPrototype) {
		...
		function customElementPrototype() {
			...
			_this4.component = new _this4.constructor.component();
			_this4.data = {};
			_this4._properties = {};
			_this4.component.methods = {};
			...
			_this4.component.data = {};
			var data = _this4.constructor._data ? _this4.constructor._data() : {};
			var def = "default";
			for (var _key5 in data) {
				_this4.component.data[_key5] = data[_key5][def];
			}
			_this4.component.data.errors = {};
			_this4.component.__data = data;
			for (var _key6 in _this4.constructor._methods) {
				_this4.component.methods[_key6] = _this4.constructor._methods[_key6];
			}
			defProp(_this4.component.data, '__component__', {
				value: _this4,
				configurable: true,
				writable: true,
				enumerable: false
			});
			_this4.component.$node = _this4;
			...
			for (var key in _this4.component.data) {
				var error = _LC.handleValidation(_this4.component.data, key, _this4.component.data[key], _this4.component);
				if (error) {
					_this4.component.data[key] = undefined;
				}
			}
			return _this4;
		}
			...
			value: function afterConnected() {
				...
				if (this._initProperties) {
					...
					for (var _key8 in initProperties) {
						var actVal = void 0;
						if (this.component.__data[_key8] && this.component.__data[_key8].type !== _LC.getDataType(initProperties[_key8]) && (initProperties[_key8] !== undefined || this.component.__data[_key8].type === "boolean")) {
							actVal = _LC.typeCast(initProperties[_key8], this.component.__data[_key8].type);
						} else {
							actVal = initProperties[_key8];
						}
						var error = _LC.handleValidation(this.component.data, _key8, actVal, this.component);
						if (!error) {
							this.component.data[_key8] = actVal;
						}
					}
				...
				if (this._initMethods) {
					...
					for (var _key9 in initMethods) {
						this.component.methods[_key9] = initMethods[_key9];
					}
        ...
        content = toAppend.cloneNode(true, "lyte");
				...
				for (var _i8 = 0; _i8 < dynamicNodes.length; _i8++) {
					...
					if (type === "componentDynamic") {
						...
						var toBeRemoved = [];
						for (var _key10 in info.attr) {
							var _attr = info.attr[_key10];
          ...
          */
				...
				if (isCustomProp !== -1) {
					...
					if (lyteProps) {
						try {
							...
							for (var _key11 in lyteProps) {
								var actKey = propValue + _LC.String.upperCaseFirstLetter(_key11);
								this.set(actKey, lyteProps[_key11]);
							}
						} catch (e) {
			...
			value: function removeHelpers(node, update, direct) {
				...
				if (node._forContent) {
					if (node.getAttribute("is") === "for") {
						...
						var _key12 = node.getAttribute("item");
						if (node._items.length) {
							...
							if (prop) {
								for (var _i16 = 0; _i16 < node._items.length; _i16++) {
									this.removeBindings(_defineProperty({}, _key12, node._items[_i16].itemProperty), _defineProperty({}, _key12, node._attributes.items[_i16]));
								}
							}
						}
						if (!update) {
						...
						var _key13 = node.getAttribute("key");
						for (var index in items) {
							...
							if (_prop) {
								this.removeBindings(_defineProperty({}, _key13, node._items[index].itemProperty), _defineProperty({}, _key13, node._attributes.object[index]));
							}
						}
						if (!update) {
							if (node._actualBinding) {
					...
					if (node._caseContent) {
						...
						for (var _key14 in node._dynamicProperty) {
							if (node._dynamicProperty[_key14].isActualNode) {
								node._dynamicProperty[_key14].isActualNode._helperNodes[del](node);
							} else {
								var helperNodes = this.getProperty(_key14)._helperNodes;
								if (helperNodes) {
					...
					for (var _key15 in node._renderedComponent) {
						node._renderedComponent[_key15] = null;
					}
				}
				...
				if (options.type !== "remove") {
					...
					for (var _k3 = firstIndexForIteration, _v4 = lastIndexForIteration; _v4 > 0; _k3++, _v4--) {
						...
						for (var d = 0; d < dynProps.length; d++) {
							var _key17 = dynProps[d];
							node._dynProps[_key17] ? node._dynProps[_key17]++ : node._dynProps[_key17] = 1;
						}
			...
			value: function processArgs(scope, args, dynamicValues, event, node) {
				...
				for (var _i36 = 0; _i36 < args.length; _i36++) {
					...
					} else if (args[_i36] && args[_i36].type) {
						this.internalHelpers(scope, args, _i36, dynamicValues, event, node);
					}
				}
				return args;
			}
			...
			value: function registerYields() {
				...
				for (var _i38 = 0; _i38 < yields.length; _i38++) {
					...
					if (yields[_i38].hasAttribute("from-parent") && this._callee && (parentYield = this._callee._yields[yields[_i38].getAttribute("yield-name")])) {
						this._yields[yields[_i38].getAttribute("yield-name")] = parentYield;
					} else {
			...
			value: function connectedCallback() {
				...
				if (templateAttributes && templateAttributes.attr) {
					for (var _key18 in templateAttributes.attr) {
						//        		let attr = templateAttributes.attr[i];
						var attr = templateAttributes.attr[_key18];
						if (!this.hasAttribute(attr.name) && !this.component.data.hasOwnProperty(attr.name) || attr.globalEvent) {
							if (attr.globalEvent) {
								...
								attr.from = "component";
								if (attr.staticValue) {
									this.setAttribute(templateAttributes.attr[_key18].name, attr.staticValue);
								} else {
									this.setAttribute(templateAttributes.attr[_key18].name, "{{dummy}}");
									this.bindNode(this.attributes.getNamedItem(templateAttributes.attr[_key18].name), [], undefined, {}, templateAttributes.attr[_key18], undefined, undefined, true);
								}
							}
						}
					}
				}
				for (var _key19 in this._toRegEvnts) {
					this.addEventListener(_key19, this._toRegEvnts[_key19].listener);
					if (this.hasAttribute(_key19)) {
						this.setAttribute(_key19, this.getAttribute(_key19) + " ; " + this._toRegEvnts[_key19].attrVal);
					} else {
						this.setAttribute(_key19, this._toRegEvnts[_key19].attrVal);
					}
				}
				this._toRegEvnts = {};
				var initialUnbound = _LC.unbound;
          ...
          delete actData._bindings;
			...
			value: function disconnectedCallback() {
				...
				for (var _key20 in this._properties) {
					this._properties[_key20] = {};
				}
					...
					for (var i = 0; i < self.__dc.length; i++) {
						...
						if (helper.hasAttribute("lyte-keep-alive")) {
							...
							for (var j = 0; j < objKeys.length; j++) {
								var _key21 = objKeys[j];
								if (_key21 !== helper._currentComponent) {
									_LC.hDiv.appendChild(helper._renderedComponent[_key21]);
									helper._renderedComponent[_key21].remove();
			...
			value: function getArrayIndex(array, value) {
				for (var _i42 = 0; _i42 < array.length; _i42++) {
					if (array[_i42] === value) {
						return _i42;
					};
				}
			...
			value: function getTrimmedContent(content, position, node) {
				...
				for (var _i43 = 0; _i43 < position.length; _i43++) {
					for (var j = content.childNodes.length - 1; j > position[_i43]; j--) {
						content.childNodes[j].remove();
					}
					content = content.childNodes[position[_i43]];
				}
				return dummyContent;
			}
		}, {
					...
					if (this._templateAttributes && this._templateAttributes.attr) {
						...
						try {
							for (var _i46 = 0; _i46 < attributesT.length; _i46++) {
								if (!this._templateAttributes.attr[attributesT[_i46].name] && attributesT[_i46].name !== "tag-name" && attributesT[_i46].name !== "use-strict") {
									this._templateAttributes.attr[attributesT[_i46].name] = { "name": attributesT[_i46].name, "staticValue": attributesT[_i46].value };
								}
							}
						} catch (e) {
				...
				if (node.nodeType === node.TEXT_NODE) {
					...
					if (nodeValue) {
						...
						for (var _i48 = 0; _i48 < mustacheValues.length; _i48++) {
							var mustacheStartIndex = nodeValue.indexOf(mustacheValues[_i48]);
	...
	var LyteComponent = {
		...
		"updateCustomCrmComponent": function updateCustomCrmComponent(def, customCrmComponent) {
			for (var _key22 in def) {
				if (def[_key22].type === "observer") {
					customCrmComponent._observers.push(def[_key22]);
				} else if (def[_key22].type === "callBack") {
					var props = def[_key22].properties;
					for (var k = 0; k < props.length; k++) {
						if (!customCrmComponent._callBacks[props[k]]) {
							customCrmComponent._callBacks[props[k]] = [];
						}
						customCrmComponent._callBacks[props[k]].push(def[_key22]);
					}
					if (def[_key22].observes) {
						customCrmComponent._observers.push(def[_key22].observes);
					}
				} else {
					customCrmComponent.component.prototype[_key22] = def[_key22];
				}
			}
			return def;
		},
   ...
   */
			...
			if (property instanceof Object) {
				if (_Lyte.isRecord(object) && !fromStore) {
					...
					for (var _key23 in property) {
						var locValue = property[_key23];
						var dataType = object.$.model.fieldList[_key23];
						...
						if (dataType && (locValue !== undefined || dataType === "boolean") && dataType !== _LC.getDataType(locValue)) {
							property[_key23] = _LC.typeCast(locValue, dataType);
						}
					}
		...
		"oF": function oF() {
			...
			if (bindings) {
				...
				for (var _i57 = 0; _i57 < bind.length; _i57++) {
					var binding = bind[_i57];
		...
		"aF": function aF() {
				...
				case "replaceAt":
					{
						...
						if (array._bindings) {
							...
							for (var _i58 = 0; _i58 < objbind.length; _i58++) {
								var item = objbind[_i58];
								if (item._forHelpers) {
          ...
          continue;
										...
										for (var _i59 = index, _j5 = 0; _i59 < finalIndex; _i59++, _j5++) {
											_LC.removeSelectedBindingDeep(_defineProperty({}, itemValue, helper._items[_i59].itemProperty), _defineProperty({}, itemValue, deletedItems[_j5]));
										}
										var contextSwitchArray = [];
								...
								for (var _key25 in item) {
									var parsedKey = parseInt(_key25);
									if (!isNaN(parsedKey) && parsedKey >= options.firstIndex) {
										...
										this.removeSelectedBindingDeep(item[_key25], _oldObject);
										if (item[_key25]._forHelpers) {
											var bindfor = item[_key25]._forHelpers.toArrayLyte();
										...
										if (array[parsedKey] && _typeof(array[parsedKey]) === "object") {
											...
											this.establishBindings({ "dummy": item[_key25] }, { "dummy": array[parsedKey] });
										}
										this.affectChanges(item[_key25]);
									}
								}
							}
						}
				...
				case "splice":
					{
						...
						if (array._bindings) {
							...
							for (var _i60 = 0; _i60 < _objbind3.length; _i60++) {
								var _item5 = _objbind3[_i60];
          ...
          continue;
										...
										for (var _i61 = _index2, _j7 = 0; _i61 < _finalIndex; _i61++, _j7++) {
											_LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue, _helper._items[_i61].itemProperty), _defineProperty({}, _itemValue, _deletedItems[_j7]));
										}
								...
								for (var _key26 in _item5) {
									var _parsedKey = parseInt(_key26);
									if (!isNaN(_parsedKey) && _parsedKey >= _options.firstIndex) {
										...
										this.removeSelectedBindingDeep(_item5[_key26], _oldObject2);
										if (_item5[_key26]._forHelpers) {
											var _bindfor = _item5[_key26]._forHelpers.toArrayLyte();
										...
										if (array[_parsedKey] && _typeof(array[_parsedKey]) === "object") {
											...
											this.establishBindings({ "dummy": _item5[_key26] }, { "dummy": array[_parsedKey] });
										}
										this.affectChanges(_item5[_key26]);
									}
								}
							}
						}
				...
				case "remove":
					{
						...
						if (array._bindings) {
							...
							for (var _i62 = 0; _i62 < _objbind4.length; _i62++) {
								var _item7 = _objbind4[_i62];
          ...
          continue;
										...
										for (var _i63 = _index3, _j9 = 0; _i63 < _finalIndex2; _i63++, _j9++) {
											_LC.removeSelectedBindingDeep(_defineProperty({}, _itemValue2, _helper2._items[_i63].itemProperty), _defineProperty({}, _itemValue2, _deletedItems2[_j9]));
										}
								...
								for (var _key27 in _item7) {
									var _parsedKey2 = parseInt(_key27);
									if (!isNaN(_parsedKey2) && _parsedKey2 >= _options2.firstIndex) {
										...
										this.removeSelectedBindingDeep(_item7[_key27], _oldObject3);
										if (_item7[_key27]._forHelpers) {
											var _bindfor2 = _item7[_key27]._forHelpers.toArrayLyte();
										...
										if (array[_parsedKey2] && _typeof(array[_parsedKey2]) === "object") {
											...
											this.establishBindings({ "dummy": _item7[_key27] }, { "dummy": array[_parsedKey2] });
										}
										this.affectChanges(_item7[_key27]);
									}
								}
							}
						}
				...
				case "insertAt":
					{
						...
						for (var _i64 = _index4; _i64 > array.length; _i64--) {
						...
						if (array._bindings) {
							...
							for (var _i65 = 0; _i65 < arrbind.length; _i65++) {
								var _item9 = arrbind[_i65];
          	...
          	continue;
								...
								for (var _key28 in _item9) {
									var _parsedKey3 = parseInt(_key28);
									if (!isNaN(_parsedKey3) && _parsedKey3 >= _options3.firstIndex) {
										this.removeSelectedBindingDeep(_item9[_key28], array[_parsedKey3 + _options3.secondIndex]);
										if (_item9[_key28]._forHelpers) {
											var _bindfor3 = _item9[_key28]._forHelpers.toArrayLyte();
										...
										if (array[_parsedKey3] && _typeof(array[_parsedKey3]) === "object") {
											...
											this.establishBindings({ "dummy": _item9[_key28] }, { "dummy": array[_parsedKey3] });
										}
										this.affectChanges(_item9[_key28]);
									}
								}
							}
						}
							...
							if (helper && helper.tagName === "TEMPLATE" && helper.getAttribute("is") === "for") {
								if (helper._items) {
									...
									for (var _i69 = 0; _i69 < helper._items.length; _i69++) {
										var _data = actualData[_i69];
										var _item11 = helper.getAttribute("item");
										if (_data) {
											if (_typeof(helper._items[_i69]) === "object") {
												this.establishBindings(helper._items[_i69].itemProperty, _defineProperty({}, _item11, _data));
											}
										}
									}
								}
		...
		"removeAllBindings": function removeAllBindings(properties, data) {
			var del = "delete";
			for (var _key29 in properties) {
				if (data[_key29] && data[_key29]._bindings) {
					//                    data[key]._bindings[del](properties[key]);
					//                    if(!data[key]._bindings.size) {
					//                        delete data[key]._bindings;
					//                    }
					deleteBindingCheckSize(data[_key29], "_bindings", properties[_key29]);
				}
				if (data[_key29] && typeof data[_key29] !== "string") {
					_LC.removeAllBindings(properties[_key29], data[_key29]);
				}
			}
		},
		"affectChanges": function affectChanges(item, contextAlreadySwitched, oldValue, setterScope, newValue) {
			...
			if (item._helperNodes) {
				...
				for (var _s3 = 0; _s3 < itemHelperNodes.length; _s3++) {
					...
					if (itemHelperNodes[_s3].getAttribute("is") === "for" && itemHelperNodes[_s3]._items) {
						...
						for (var _key30 in itemHelperNodes[_s3]._items) {
							_callee5.component.data[_itemValue3] = object[_key30];
							_callee5.component.data[_indexValue] = _key30;
							_callee5._properties[_itemValue3] = itemHelperNodes[_s3]._items[_key30].itemProperty;
							if (itemHelperNodes[_s3]._items[_key30]._dynamicProperty[propPath]) {
								nodes = itemHelperNodes[_s3]._items[_key30]._dynamicProperty[propPath];
			...
			if (Array.isArray(item)) {
				for (var i = 0; i < item.length; i++) {
					for (var _key31 in item[i]) {
						this.affectChanges(item[i][_key31], true, oldValue ? oldValue[i] ? oldValue[i][_key31] : oldValue[i] : oldValue, setterScope, newValue ? newValue[i] ? newValue[i][_key31] : newValue[i] : newValue);
					}
				}
			} else {
				for (var _key32 in item) {
					this.affectChanges(item[_key32], true, oldValue ? oldValue[_key32] : oldValue, setterScope, newValue ? newValue[_key32] : newValue);
				}
			}
		},
		...
		"componentSetMethods": function componentSetMethods(arg0, arg1) {
			if (typeof arg0 === "string") {
				...
				for (var _key34 in arg0) {
					this.methods[_key34] = arg0[_key34];
				}
			}
		},
				...
				case "switch":
					{
						...
						if (_Lyte._ms) {
							...
							for (var _key35 in info.cases) {
								var content = _LC.getContentForIE(dynNContent.querySelector("[case='" + _LC.cssEscape(_key35) + "']"));
								doCompile(content.tagName === "TEMPLATE" ? content.content : content, info.cases[_key35].dynamicNodes, componentName, constr);
							}
							if (info[def].dynamicNodes) {
		...
		value: function value(arg0, arg1) {
			...
			if (typeof arg0 === "string") {
				...
				for (var _key36 in arg0) {
					this._initProperties[_key36] = arg0[_key36];
				}
			}
		}
	});
		...
		value: function value(arg0, arg1) {
			...
			if (typeof arg0 === "string") {
				...
				for (var _key37 in arg0) {
					this._initMethods[_key37] = arg0[_key37];
				}
			}
		}
	});
